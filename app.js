$(() => {
  ...
  const projectVideos = ['maze-explorer.mov', 'tomstagram.mov', 'crave.mov', 'content.mov'];
  ...
  function selectProject(e){
    ...
    demoContainer
      .append( `<video src="videos/${projectVideos[e.target.value]}" autoplay loop poster=""></video>` );
  }
